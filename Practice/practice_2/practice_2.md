...
Запустите MissionPlanner, далее после ввода команд в три терминала, как описано в разделе "Этап 2", перейдите в Mission Planer, в правом верхнем углу выберите способ подключения TCP, нажмите "Connect" и подключитесь к ip `127.0.0.1` к порту `5762`.
