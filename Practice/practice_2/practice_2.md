...
Данная практическая работа направлена на получение практических навыков подготовки окружения к запуску и практическому применению SITL на примере симулятора Gazebo, автопилота Ardupilot и наземной станции управления Mission Planer.
